...
public class QueryBuilderUtils {
    ...
    public static String buildSqlUsingLike(String table, String field, String input) {
        if (!StringUtils.isNullOrEmpty(input)) {
            if (!StringUtils.isNullOrEmpty(table) && !StringUtils.isNullOrEmpty(field)) {
    ...
    public static <T> String buildSqlUsingEqualOperator(String table, String field, T input) {
        if (input != null) {
            if (!StringUtils.isNullOrEmpty(table) && !StringUtils.isNullOrEmpty(field)) {
    ...
    public static <T> String buildingSqlWithJoin(String table1, String field1, String table2, String field2) {

        if (!StringUtils.isNullOrEmpty(table1) && !StringUtils.isNullOrEmpty(field1)
                && !StringUtils.isNullOrEmpty(table2) && !StringUtils.isNullOrEmpty(field2)) {
